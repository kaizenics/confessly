    ...
    <div>
      <Container className="container mx-auto">
        ...
        <div className="top-8 -z-10 absolute sm:hidden">
            <Image src={hearts} alt="hearts" width={90} height={90} layout="fixed" />
          </div>
          <div className="relative sm:mr-8">
            {!user ? (
              ...
              <div>
                <p className="font-montserrat text-white text-center sm:text-start text-[4vw] sm:text-md lg:text-2xl">Welcome, {user.displayName}!</p>
